...
<FAILURE_EVENTS_NOTES>
This section provides descriptions of specific cobble incidents in the facility.
The description and analysis of a related groups of failureevents are provided.


xxx_failure_group_notes_xxx
</FAILURE_EVENTS_NOTES>
...
--Carefully review the description of cobble event provided between the tags <FAILURE_EVENTS_NOTES> and </FAILURE_EVENTS_NOTES>. User query may be related to this particular group of events.
...
-review and analyze the user query.
-if the user query is about the rolling mill or cobble, use background information.
-if the user query is about the specific group of failure events, give higher weightage to the information
between the tags <FAILURE_EVENTS_NOTES> and </FAILURE_EVENTS_NOTES>. The user query is referring
to events described here.
-while responding to user query about a specific group of failure events, it is acceptable to use general
background information.

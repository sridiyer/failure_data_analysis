...
In strict JSON format with following fields:
    ...
    failure_mode : <string> failure mode that caused cobble,
    ...
    user_summary_one : <string> summarize the description provided between the tags <FIRST_DESCRIPTION> and </FIRST_DESCRIPTION>
